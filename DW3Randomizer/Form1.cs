        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (TextReader reader = File.OpenText("lastFile" + shortVersion + ".txt"))
                {
                    ...
                    if (reader.ReadLine() == "Checked") tchk_StdCaseMenus.CheckState = CheckState.Checked;
                    else if (reader.ReadLine() == "Unchecked") tchk_StdCaseMenus.CheckState = CheckState.Unchecked;
                    else tchk_StdCaseMenus.CheckState = CheckState.Indeterminate;
                    if (reader.ReadLine() == "Checked") tchk_FixSlimeSnail.CheckState = CheckState.Checked;
                    else if (reader.ReadLine() == "Unchecked") tchk_FixSlimeSnail.CheckState = CheckState.Unchecked;
                    else tchk_FixSlimeSnail.CheckState = CheckState.Indeterminate;
                    if (reader.ReadLine() == "Checked") tchk_RandSpriteColor.CheckState = CheckState.Checked;
                    else if (reader.ReadLine() == "Unchecked") tchk_RandSpriteColor.CheckState = CheckState.Unchecked;
                    else tchk_RandSpriteColor.CheckState = CheckState.Indeterminate;
                    if (reader.ReadLine() == "Checked") tchk_ChangeCats.CheckState = CheckState.Checked;
                    else if (reader.ReadLine() == "Unchecked") tchk_ChangeCats.CheckState = CheckState.Unchecked;
                    else tchk_ChangeCats.CheckState = CheckState.Indeterminate;
                    if (reader.ReadLine() == "Checked") tchk_FixFFighterSprite.CheckState = CheckState.Checked;
                    else if (reader.ReadLine() == "Unchecked") tchk_FixFFighterSprite.CheckState = CheckState.Unchecked;
                    else tchk_FixFFighterSprite.CheckState = CheckState.Indeterminate;
                    if (reader.ReadLine() == "Checked") tchk_RandNPCSprites.CheckState = CheckState.Checked;
                    else if (reader.ReadLine() == "Unchecked") tchk_RandNPCSprites.CheckState = CheckState.Unchecked;
                    else tchk_RandNPCSprites.CheckState = CheckState.Indeterminate;
                    if (reader.ReadLine() == "Checked") tchk_FemaleHero.CheckState = CheckState.Checked;
                    else if (reader.ReadLine() == "Unchecked") tchk_FemaleHero.CheckState = CheckState.Unchecked;
                    else tchk_FemaleHero.CheckState = CheckState.Indeterminate;
                    runChecksum();
                }
            }
            catch
